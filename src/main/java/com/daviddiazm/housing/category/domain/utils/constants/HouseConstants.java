...
public class HouseConstants {
    ...
    public static final String SAVE_CORRECTLY_MESSAGE = "The house saved correctly";

    public static final int MIN_SECTOR_CARACTER_LENGTH = 3;
    public static final int MAX_SECTOR_CARACTER_LENGTH = 50;

    public static final int MIN_DESCRIPTION_CARACTER_LENGTH = 10;
    public static final int MAX_DESCRIPTION_CARACTER_LENGTH = 90;

    public static final String SECTOR_NULL_MESSAGE = "Field 'sector name' can not be null";
    public static final String FIELD_DESCRIPTION_NULL_MESSAGE = "Field 'description' can not be null";

    public static final String SECTOR_MIN_LENGHT = "The min length for sector name needs most to be 3 caracters";
    public static final String SECTOR_MAX_LENGHT = "The max length for sector name needs most to be 50 caracters";
    ...
    public static final String SECTOR_ALREADY_EXIST = "The sector name is already exist";
    public static final String MUNICIPALITY_NO_EXIST = "The municipality not exist";
