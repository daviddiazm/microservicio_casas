...
public class HouseConstants {
    ...
    public static final String PUBLISH_DATE_EXCEES = "The publis date house excees the moth";
    ...
    public static final int MAX_ROOMS_CARACTER_LENGTH = 90;

    public static final int MIN_ADRESS_CARACTER_LENGTH = 5;
    public static final int MAX_ADRESS_CARACTER_LENGTH = 200;
    ...
    public static final String DESCRIPTION_MAX_ROOMS = "The max rooms are 90";

    public static final String ADRESS_MIN_LENGHT = "The min length for adress needs most to be 10 caracters";
    public static final String ADRESS_MAX_LENGHT = "The max length for adress needs most to be 90 caracters";
